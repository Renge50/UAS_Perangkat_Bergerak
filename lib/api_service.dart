  ...
  Future<List<Perusahaan>> getPerusahaan() async {
    try {
      ...
      if (responseBody is Map<String, dynamic>) {
        final perusahaans = responseBody['perusahaans'];
        if (perusahaans is Map<String, dynamic>) {
          final data = perusahaans['data'] as List<dynamic>;
          return data.map((item) => Perusahaan.fromJson(item)).toList();
        } else {
